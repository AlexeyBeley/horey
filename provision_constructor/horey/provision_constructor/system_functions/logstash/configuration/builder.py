...
class Builder(SystemFunctionFactory.SystemFunction):
    ...
    def add_pipelines(self, pipeline_names):
        ...
        with open(
            os.path.join(
                os.path.dirname(os.path.abspath(__file__)), "base_pipeline.conf"
            ),
            "r",
        ) as file_handler:

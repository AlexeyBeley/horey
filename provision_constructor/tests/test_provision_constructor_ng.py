...
def test_add_system_function_swap():
    provision_constructor = ProvisionConstructor()
    provision_constructor.add_system_function("swap", ram_size_in_gb=4, horey_repo_path=os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", ".."))
...
def test_add_system_function_logstash():
    ...
    provision_constructor.provision_system_function("horey_package_generic", package_name="aws_api", horey_repo_path="/home/ubuntu/git/horey/")
    provision_constructor.provision_system_function("horey_package_generic", package_name="serverless", horey_repo_path="/home/ubuntu/git/horey/")
    provision_constructor.provision_system_function("horey_package_generic", package_name="network", horey_repo_path="/home/ubuntu/git/horey/")
    provision_constructor.provision_system_function("horey_package_generic", package_name="deployer", horey_repo_path="/home/ubuntu/git/horey/")
    provision_constructor.provision_system_function("horey_package_generic", package_name="zabbix_api", horey_repo_path="/home/ubuntu/git/horey/")
    provision_constructor.provision_system_function("horey_package_generic", package_name="docker_api", horey_repo_path="/home/ubuntu/git/horey/")
    provision_constructor.provision_system_function("horey_package_generic", package_name="replacement_engine", horey_repo_path="/home/ubuntu/git/horey/")
    provision_constructor.provision_system_function("horey_package_generic", package_name="azure_api", horey_repo_path="/home/ubuntu/git/horey/")

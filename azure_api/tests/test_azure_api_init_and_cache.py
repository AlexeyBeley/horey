...
def test_init_and_cache_load_balancers():
    ...
    azure_api.cache_objects(azure_api.load_balancers, configuration.azure_api_load_balancers_cache_file)
...
def test_init_and_cache_nat_gateways():
    ...
    azure_api.cache_objects(azure_api.nat_gateways, configuration.azure_api_nat_gateways_cache_file)
...
def test_init_and_cache_network_interfaces():
    ...
    azure_api.cache_objects(azure_api.network_interfaces, configuration.azure_api_network_interfaces_cache_file)
...
def test_init_and_cache_public_ip_addresses():
    ...
    azure_api.cache_objects(azure_api.public_ip_addresses, configuration.azure_api_public_ip_addresses_cache_file)
...
def test_init_and_cache_network_security_groups():
    ...
    azure_api.cache_objects(azure_api.network_security_groups, configuration.azure_api_network_security_groups_cache_file)
    logger.info(f"len(network_security_groups) = {len(azure_api.network_security_groups)}")
...
def test_init_and_cache_ssh_keys():
    ...
    azure_api.cache_objects(azure_api.ssh_keys, configuration.azure_api_ssh_keys_cache_file)
...
def test_init_and_cache_virtual_machines():
    ...
    azure_api.cache_objects(azure_api.virtual_machines, configuration.azure_api_virtual_machines_cache_file)

...
class AzureAccount:
    ...
    def get_azure_account():
        ...
        :return:
        """
        return AzureAccount._CURRENT_ACCOUNT

    @staticmethod
    def set_azure_account(value):
        """
        Set current account to work against.
        :param value:
        :return:
        """
        AzureAccount._CURRENT_ACCOUNT = value
    ...
    def get_azure_region():
        ...
        :return:
        """
        return AzureAccount._CURRENT_REGION

    @staticmethod
    def set_azure_region(value):
        """
        ...
        AzureAccount._CURRENT_REGION = value
    ...
    def _init_connection_steps_from_list(self, lst_src):
        ...
        for connection_step_dict in lst_src:
            connection_step = AzureAccount.ConnectionStep(connection_step_dict)

...
def disable_jobs_parser():
    usage_example = (
        "jenkins_manager_actor.py --action disable_jobs --input_file ${ROOT_DIR}/jenkins_disable.txt"
...
def delete_jobs_parser():
    usage_example = (
        "jenkins_manager_actor.py --action delete_jobs --input_file ${ROOT_DIR}/jenkins_disable.txt"
        " --configuration_file_full_path ${ROOT_DIR}/jenkins_configuration_file.py"
    )

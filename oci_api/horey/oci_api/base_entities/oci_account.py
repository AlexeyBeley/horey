"""
OCI account management module - defines how to connect to an account in order to run API calls in in.
"""
import pdb
...
class OCIAccount:
    ...
    def get_oci_account():
        ...
        :return:
        """
        return OCIAccount._CURRENT_ACCOUNT

    @staticmethod
    def set_oci_account(value):
        """
        Set current account to work against.
        :param value:
        :return:
        """
        OCIAccount._CURRENT_ACCOUNT = value
    ...
    def get_oci_region():
        ...
        :return:
        """
        return OCIAccount._CURRENT_REGION

    @staticmethod
    def set_oci_region(value):
        """
        ...
        OCIAccount._CURRENT_REGION = value
    ...
    def _init_connection_steps_from_list(self, lst_src):
        ...
        for connection_step_dict in lst_src:
            connection_step = OCIAccount.ConnectionStep(connection_step_dict)

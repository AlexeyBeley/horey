"""
Google account management module - defines how to connect to an account in order to run API calls in in.
"""
import pdb
from enum import Enum
from horey.google_api.base_entities.region import Region
...
class GoogleAccount:
    ...
    def get_google_account():
        ...
        :return:
        """
        return GoogleAccount._CURRENT_ACCOUNT

    @staticmethod
    def set_google_account(value):
        """
        Set current account to work against.
        :param value:
        :return:
        """
        GoogleAccount._CURRENT_ACCOUNT = value

    @staticmethod
    def get_google_region():
        """
        Get current region to work against.
        :return:
        """
        return GoogleAccount._CURRENT_REGION

    @staticmethod
    def set_google_region(value):
        """
        ...
        GoogleAccount._CURRENT_REGION = value
    ...
    def _init_connection_steps_from_list(self, lst_src):
        ...
        for connection_step_dict in lst_src:
            connection_step = GoogleAccount.ConnectionStep(connection_step_dict)

...
from horey.kubernetes_api.base_entities.region import Region
...
class KubernetesAccount:
    ...
    @staticmethod
    def get_kubernetes_region():
        """
        Get current region to work against.
        :return:
        """
        return KubernetesAccount._CURRENT_REGION

    @staticmethod
    def set_kubernetes_region(value):
        """
        ...
        KubernetesAccount._CURRENT_REGION = value
    ...
    def _init_connection_steps_from_list(self, lst_src):
        ...
        for connection_step_dict in lst_src:
            connection_step = KubernetesAccount.ConnectionStep(connection_step_dict)

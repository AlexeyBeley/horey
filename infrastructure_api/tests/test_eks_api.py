...
from horey.infrastructure_api.eks_api import EKSAPI,  EKSAPIConfigurationPolicy
...
@pytest.fixture(name="eks_api")
def fixture_eks_api(env_api_integration):
    eks_api_configuration = EKSAPIConfigurationPolicy()
    eks_api = EKSAPI(eks_api_configuration, env_api_integration)
    yield eks_api

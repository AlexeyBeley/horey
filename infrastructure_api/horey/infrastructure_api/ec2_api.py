...
class EC2API:
    ...
    def start_instance(self, name=None, asynchronous=True):
        """
        Stop EC2 instance.
        ...
        if ec2_instance.is_alive():
            return True

        self.environment_api.aws_api.ec2_client.start_instances([ec2_instance], asynchronous=asynchronous)
        return ec2_instance

...
def test_convert_to_dict():
    ...
    assert ret == {'dict_src': {'dict_src': 'dict_src'}, 'uuid': '62fe1fa6-d5a4-4c22-b523-d85e82a44954',
                   'data': '{"key": "value"}',
                   'type': 'TEST_MESSAGE'}

def test_init_from_dict():
    message = Message({"dict_src": "dict_src"})
    message.init_from_dict({'dict_src': {'dict_src': 'dict_src'}, 'uuid': '62fe1fa6-d5a4-4c22-b523-d85e82a44954',
                   'data': '{"key": "value"}',
                   'type': 'TEST_MESSAGE'})

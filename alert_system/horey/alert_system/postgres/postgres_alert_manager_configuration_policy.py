...
class PostgresAlertManagerConfigurationPolicy(ConfigurationPolicy):
    ...
    def __init__(self):
        ...
        self._db_load_non_cpu = None
        self._read_iops_local_storage = None
        ...
        self._replica_lag = None
        self._free_storage_space = None
        ...
        self._transaction_logs_generation = None
    ...
    @property
    def db_load_non_cpu(self):
        if self._db_load_non_cpu is None:
            self._db_load_non_cpu = None
        return self._db_load_non_cpu

    @db_load_non_cpu.setter
    def db_load_non_cpu(self, value):
        self._db_load_non_cpu = value

    @property
    def read_iops_local_storage(self):
        if self._read_iops_local_storage is None:
            self._read_iops_local_storage = None
        return self._read_iops_local_storage

    @read_iops_local_storage.setter
    def read_iops_local_storage(self, value):
        self._read_iops_local_storage = value
    ...
    @property
    def replica_lag(self):
        if self._replica_lag is None:
            self._replica_lag = None
        return self._replica_lag

    @replica_lag.setter
    def replica_lag(self, value):
        self._replica_lag = value

    @property
    def free_storage_space(self):
        if self._free_storage_space is None:
            self._free_storage_space = None
        return self._free_storage_space

    @free_storage_space.setter
    def free_storage_space(self, value):
    ...
    @property
    def db_load_cpu(self):
        if self._db_load_cpu is None:
            self._db_load_cpu = None
        return self._db_load_cpu

    @db_load_cpu.setter
    def db_load_cpu(self, value):
        self._db_load_cpu = value
    ...
    @property
    def checkpoint_lag(self):
        if self._checkpoint_lag is None:
            self._checkpoint_lag = None
        return self._checkpoint_lag

    @checkpoint_lag.setter
    def checkpoint_lag(self, value):
        self._checkpoint_lag = value
    ...
    @property
    def maximum_used_transaction_i_ds(self):
        if self._maximum_used_transaction_i_ds is None:
            self._maximum_used_transaction_i_ds = None
        return self._maximum_used_transaction_i_ds

    @maximum_used_transaction_i_ds.setter
    def maximum_used_transaction_i_ds(self, value):
    ...
    @property
    def read_latency_local_storage(self):
        if self._read_latency_local_storage is None:
            self._read_latency_local_storage = None
        return self._read_latency_local_storage

    @read_latency_local_storage.setter
    def read_latency_local_storage(self, value):
        self._read_latency_local_storage = value
    ...
    @property
    def write_throughput_local_storage(self):
        if self._write_throughput_local_storage is None:
            self._write_throughput_local_storage = None
        return self._write_throughput_local_storage

    @write_throughput_local_storage.setter
    def write_throughput_local_storage(self, value):
        self._write_throughput_local_storage = value

    @property
    def db_load(self):
        if self._db_load is None:
            self._db_load = None
        return self._db_load

    @db_load.setter
    def db_load(self, value):
        self._db_load = value

    @property
    def read_throughput_local_storage(self):
        if self._read_throughput_local_storage is None:
            self._read_throughput_local_storage = None
        return self._read_throughput_local_storage

    @read_throughput_local_storage.setter
    def read_throughput_local_storage(self, value):
        self._read_throughput_local_storage = value
    ...
    @property
    def db_load_relative_to_num_vcp_us(self):
        if self._db_load_relative_to_num_vcp_us is None:
            self._db_load_relative_to_num_vcp_us = None
        return self._db_load_relative_to_num_vcp_us

    @db_load_relative_to_num_vcp_us.setter
    def db_load_relative_to_num_vcp_us(self, value):
        self._db_load_relative_to_num_vcp_us = value
    ...
    @property
    def write_latency_local_storage(self):
        if self._write_latency_local_storage is None:
            self._write_latency_local_storage = None
        return self._write_latency_local_storage

    @write_latency_local_storage.setter
    def write_latency_local_storage(self, value):
        self._write_latency_local_storage = value
    ...
    @property
    def transaction_logs_generation(self):
        if self._transaction_logs_generation is None:
            self._transaction_logs_generation = None
        return self._transaction_logs_generation

    @transaction_logs_generation.setter
    def transaction_logs_generation(self, value):
        self._transaction_logs_generation = value
    ...
    @property
    def write_iops_local_storage(self):
        if self._write_iops_local_storage is None:
            self._write_iops_local_storage = None
        return self._write_iops_local_storage

    @write_iops_local_storage.setter
    def write_iops_local_storage(self, value):
        self._write_iops_local_storage = value

    @property
    def free_local_storage(self):
        if self._free_local_storage is None:
            self._free_local_storage = None
        return self._free_local_storage

    @free_local_storage.setter
    def free_local_storage(self, value):
        self._free_local_storage = value

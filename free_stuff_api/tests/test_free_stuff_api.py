...
@pytest.fixture(scope="module", name="eks_free_stuff_api")
def fixture_eks_free_stuff_api():
    free_stuff_api = FreeStuffAPI(config)
    config.chromedriver_path = Path("/opt/chrome-driver/chromedriver")
    config.chrome_path = Path("/opt/chrome/chrome")
    yield free_stuff_api
...
def test_notify_about_new_item():
    free_stuff_api = FreeStuffAPI(config)
    url = ('https://www.facebook.com/marketplace/item/951081683937401/?ref=category_feed&referral_code=null&referral_story_type=listing&tracking=%7B%22qid%22%3A%22-'
           '7208799824235551155%22%2C%22mf_story_key%22%3A%2226591833053762219%22%2C%22commerce_rank_obj%22%3A%22%7B%5C%22target_id%5C%22%3A26591833053762219%2C%5C%'
           '22target_type%5C%22%3A0%2C%5C%22primary_position%5C%22%3A36%2C%5C%22ranking_signature%5C%22%3A5258348999073026090%2C%5C%22ranking_request_id%5C%22%3A9077'
           '53257306275608%2C%5C%22commerce_channel%5C%22%3A504%2C%5C%22value%5C%22%3A0.010212191960216%2C%5C%22candidate_retrieval_source_map%5C%22%3A%7B%5C%22265918'
           '33053762219%5C%22%3A3001%7D%7D%22%7D&__tn__=!%3AD')

    image_url = ('https://scontent-ord5-2.xx.fbcdn.net/v/t39.84726-6/655689552_2096376911202768_5175015685651605039_n.jpg?stp=c0.87.526.526a_dst-jpg_p526x395_tt6&_'
                 'nc_cat=103&ccb=1-7&_nc_sid=92e707&_nc_ohc=ohuQ_BIylTsQ7kNvwE9l7n4&_nc_oc=Adp85U_yKavgCJ8TR5m_8I_jgBGXxKD41x0i08zHAW6fA0gwl0WA7K4HP2UwmrOfsyI&_'
                 'nc_zt=14&_nc_ht=scontent-ord5-2.xx&_nc_gid=Upe7bcFcJ5AzRRVLGeyEOQ&_nc_ss=7a30f&oh=00_AfwHui_aKVKaDF6THy2XB4Kr9oj70oOUdXlSkDgcufoIeg&oe=69C5136E')

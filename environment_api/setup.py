...
from horey.environment_api import __version__
...
setup(
    ...
    license="DWTFYWTPL",
    packages=find_namespace_packages(include=["horey.environment_api", "horey.environment_api.*"]),
    package_data={
        "": ["environment_api/**/*.sh"],
    },

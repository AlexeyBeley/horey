...
class AWSAPI:
    ...
    def __init__(self, configuration=None, init_configuration=True, aws_account=None):

        # todo: account = self.get_working_aws_account()
        self.efs_client = EFSClient(aws_account=aws_account)
        self.ssm_client = SSMClient(aws_account=aws_account)
        self.glue_client = GlueClient(aws_account=aws_account)
        self.ec2_client = EC2Client(aws_account=aws_account)
        self.lambda_client = LambdaClient(aws_account=aws_account)
        self.iam_client = IamClient(aws_account=aws_account)
        self.s3_client = S3Client(aws_account=aws_account)
        self.elbv2_client = ELBV2Client(aws_account=aws_account)
        self.elb_client = ELBClient(aws_account=aws_account)
        self.rds_client = RDSClient(aws_account=aws_account)
        self.route53_client = Route53Client(aws_account=aws_account)
        self.cloud_watch_logs_client = CloudWatchLogsClient(aws_account=aws_account)
        self.cloud_watch_client = CloudWatchClient(aws_account=aws_account)
        self.ecs_client = ECSClient(aws_account=aws_account)
        self.pricing_client = PricingClient(aws_account=aws_account)
        self.dynamodb_client = DynamoDBClient(aws_account=aws_account)
        self.sesv2_client = SESV2Client(aws_account=aws_account)
        self.ses_client = SESClient(aws_account=aws_account)
        self.sns_client = SNSClient(aws_account=aws_account)
        self.autoscaling_client = AutoScalingClient(aws_account=aws_account)
        self.application_autoscaling_client = ApplicationAutoScalingClient(aws_account=aws_account)
        self.cloudfront_client = CloudfrontClient(aws_account=aws_account)
        self.stepfunctions_client = StepfunctionsClient(aws_account=aws_account)
        self.events_client = EventsClient(aws_account=aws_account)
        self.secretsmanager_client = SecretsManagerClient(aws_account=aws_account)
        self.servicediscovery_client = ServicediscoveryClient(aws_account=aws_account)
        self.elasticsearch_client = ElasticsearchClient(aws_account=aws_account)
        self.ecr_client = ECRClient(aws_account=aws_account)
        self.acm_client = ACMClient(aws_account=aws_account)
        self.kms_client = KMSClient(aws_account=aws_account)
        self.eks_client = EKSClient(aws_account=aws_account)
        self.elasticache_client = ElasticacheClient(aws_account=aws_account)
        self.sqs_client = SQSClient(aws_account=aws_account)
        self.sts_client = STSClient(aws_account=aws_account)
        self.efs_client = EFSClient(aws_account=aws_account)
        self.wafv2_client = WAFV2Client(aws_account=aws_account)
        self.backup_client = BackupClient(aws_account=aws_account)
